    ...
    def p_sample_loop_progressive(
        ...
        if start_timesteps is None:
            ...
            if end_timesteps is None:
                ...
                indices = list(range(end_timesteps, start_timesteps))[::-1]
        ...
        if filter_dict is not None:
            apply_filter = True
            down, up, ref_img = filter_dict['down'], filter_dict['up'], filter_dict['ref_img']
        else:
            apply_filter = False
        ...
        for i in indices:
            ...
            with th.no_grad():
                ...
                if apply_filter and t[0] >= reg_end_timesteps:
                    # replace the low frequency content
                    img = img - up(down(img)) + up(down(self.q_sample(ref_img, t - 1)))
