...
To pre-train your own SwinIR on synthetic dataset, generated by a commonly used degradation pipeline, do the followings:
```
# define paths
...
To get the pre-trained Codeformer, please refer to their official implementation [here](https://github.com/sczhou/CodeFormer). We used the released checkpoint from CodeFormer authors as the pre-trained model.
